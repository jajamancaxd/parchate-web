...
<form id="eventoForm" method="POST" action="{{ route('eventos.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="container">
        <div class="section">
            <label>Nombre del evento</label>
            <input type="text" id="nombreEvento" name="nombre_evento" placeholder="Ingrese el nombre del evento" />
        </div>

        <div class="section">
            <label>Descripción del evento</label>
            <textarea id="descripcionEvento" name="descripcion_evento" placeholder="Describe tu evento"></textarea>
        </div>
            ...
            <div class="date-group">
                <div class="date-picker">
                    ...
                    <div class="date-input-wrapper">
                        <input id="fechaInicio" type="date" name="fecha_inicio_evento" />
                ...
                <div class="date-picker">
                    ...
                    <div class="date-input-wrapper">
                        <input id="fechaFin" type="date" name="fecha_fin_evento" />
        ...
        <div class="section">
            ...
            <div id="service-container">
                <div class="service-row">
                    <input type="text" placeholder="Ingrese el producto o servicio" name="productos[]" />
        ...
        <div class="section">
            ...
            <input type="text" id="ubicacionEvento" name="ubicacion_dada_evento" placeholder="Ingrese la ubicación de la sucursal del evento" />
        </div>

        <!-- Campos ocultos para etiquetas y horario -->
        <input type="hidden" name="etiquetas" id="inputEtiquetas" />
        <input type="hidden" name="hora_inicio_evento" id="inputHorario" />
